 ...
 * syntax highlighting. Falls back to mortise-dark/mortise-light (transparent bg)
 * when no Shiki theme is configured.
 */

import * as React from 'react'
import { ShikiDiffViewer as BaseShikiDiffViewer, type ShikiDiffViewerProps as BaseProps } from '@mortise/ui'
