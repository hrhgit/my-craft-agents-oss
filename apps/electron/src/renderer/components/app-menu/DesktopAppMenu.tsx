...
/**
 * Desktop AppMenu — Mortise logo dropdown with Edit/View/Window/Settings/Help/Debug submenus.
 *
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <TopBarButton aria-label={t("menu.mortiseMenu")}>
          <MortiseSymbol className="h-4 text-accent" />
        </TopBarButton>
      </DropdownMenuTrigger>
