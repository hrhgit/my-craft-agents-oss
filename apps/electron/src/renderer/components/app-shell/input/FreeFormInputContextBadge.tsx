...
/**
 * FreeFormInputContextBadge - Unified context badge for file and folder selectors
 *
 * Visual States:
    ...
    const button = (
      <button
        ...
        className={cn(
          ...
          "input-toolbar-btn inline-flex items-center gap-1.5 h-8 rounded-[6px] text-[13px] text-foreground transition-colors select-none shrink min-w-0",
