...
/**
 * Mock Pi providers for the mobile playground.
 *
 ...
 */
export const MOCK_PI_PROVIDERS: PiGlobalProviderForDisplay[] = [
  {
    key: 'anthropic',
    apiKeyMasked: '****',
    modelCount: 1,
    provider: { models: [{ id: 'claude-opus-4-8', name: 'Claude Opus' }] },
  },
  {
    key: 'openrouter',
    apiKeyMasked: '****',
    modelCount: 2,
    provider: { baseUrl: 'https://openrouter.ai/api/v1', models: [
      {
