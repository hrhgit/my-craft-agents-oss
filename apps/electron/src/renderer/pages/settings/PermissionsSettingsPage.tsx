 ...
 * Shows both default patterns (from ~/.mortise/permissions/default.json)
 * and custom workspace additions (from workspace permissions.json).
 *
 * Default patterns can be edited by the user in ~/.mortise/permissions/default.json.
...
/**
 * Build default permissions data from ~/.mortise/permissions/default.json.
