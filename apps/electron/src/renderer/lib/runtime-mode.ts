...
export function resolveMortiseTestMode({ search, viteTestMode }: MortiseRuntimeModeInput): boolean {
...
export function isMortiseTestMode(): boolean {
  return resolveMortiseTestMode({
