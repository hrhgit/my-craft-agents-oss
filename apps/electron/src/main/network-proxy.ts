...
import { getNetworkProxySettings, setNetworkProxySettings } from '@mortise/shared/config/storage';
import type { NetworkProxySettings } from '@mortise/shared/config/types';
