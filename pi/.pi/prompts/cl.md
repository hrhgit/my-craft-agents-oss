...
Attribution:
- Internal: `Fixed foo ([#123](https://github.com/hrhgit/mortise/issues/123))`
- External: `Added bar ([#456](https://github.com/hrhgit/mortise/pull/456) by [@user](https://github.com/user))`
