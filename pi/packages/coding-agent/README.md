...
| `/network-reset` | Reset network routing state and restart the sidecar |
...
- **Package update check:** disabled by default. Enable it with `PI_CHECK_PACKAGE_UPDATES=1`; force-disable it with `PI_SKIP_PACKAGE_UPDATE_CHECK=1`.
