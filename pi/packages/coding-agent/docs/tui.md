...
**Source:** [`@mortise/pi-tui`](https://github.com/hrhgit/mortise/tree/main/pi/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@mortise/pi-tui";
...
```typescript
import { Container, type Focusable, Input } from "@mortise/pi-tui";
...
Import from `@mortise/pi-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@mortise/pi-tui";
```
...
```typescript
import { matchesKey, Key } from "@mortise/pi-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@mortise/pi-tui";
...
```typescript
import { getMarkdownTheme } from "@mortise/pi-coding-agent";
import { Markdown } from "@mortise/pi-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@mortise/pi-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@mortise/pi-coding-agent";
import { DynamicBorder } from "@mortise/pi-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@mortise/pi-tui";
...
```typescript
import { BorderedLoader } from "@mortise/pi-coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@mortise/pi-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@mortise/pi-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@mortise/pi-tui";
...
**Examples:** [widget-placement.ts](../examples/extensions/widget-placement.ts), [todo.ts](../examples/extensions/todo.ts)
...
import { matchesKey, truncateToWidth } from "@mortise/pi-tui";
