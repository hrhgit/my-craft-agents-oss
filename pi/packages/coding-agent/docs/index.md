...
```bash
npm uninstall -g @mortise/pi-coding-agent
```

For pnpm, Yarn, or Bun installs, use the matching global remove command: `pnpm remove -g @mortise/pi-coding-agent`, `yarn global remove @mortise/pi-coding-agent`, or `bun uninstall -g @mortise/pi-coding-agent`.
