...
Reference for environment variables and `auth.json` keys: [`const envMap`](https://github.com/hrhgit/mortise/blob/main/pi/packages/ai/src/env-api-keys.ts) in [`packages/ai/src/env-api-keys.ts`](https://github.com/hrhgit/mortise/blob/main/pi/packages/ai/src/env-api-keys.ts).
