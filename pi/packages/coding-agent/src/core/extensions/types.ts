 ...
 * - Register host-visible commands
 * - Interact with the user through versioned host-rendered contracts
 */
...
/**
 * Host-rendered UI context for extensions.
 */
export interface ExtensionUIContext {
	/** Explicit host UI surface. */
...
/** Fired after an agent loop and all automatic follow-up work have fully settled. */
...
/** Shared state created by the loader and completed when the runner binds. */
