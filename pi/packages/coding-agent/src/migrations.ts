 ...
 */
function migrateExtensionSystem(cwd: string, projectConfigDir: string): string[] {
	const agentDir = getAgentDir();
	const projectDir = join(cwd, projectConfigDir);
...
export function runMigrations(
	...
	const deprecationWarnings = migrateExtensionSystem(cwd, projectConfigDir);
