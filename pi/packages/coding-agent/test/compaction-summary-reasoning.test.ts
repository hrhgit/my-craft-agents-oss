...
import type { AssistantMessage, Model } from "@mortise/pi-ai";
...
vi.mock("@mortise/pi-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@mortise/pi-ai")>();
	return {
		...actual,
