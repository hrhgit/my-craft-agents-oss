#!/usr/bin/env bash
# install-server.sh — Set up the Mortise Agent standalone server.
#
# Usage:
...
echo ""
echo "===================================="
echo "  Mortise Agent Server Ready"
echo "===================================="
echo ""
echo "Start the server (with Web UI):"
echo ""
echo "  MORTISE_SERVER_TOKEN=$TOKEN \\"
echo "  MORTISE_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  MORTISE_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
...
echo "  MORTISE_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  MORTISE_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  MORTISE_RPC_HOST=0.0.0.0 \\"
echo "  MORTISE_RPC_PORT=9100 \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""
...
echo "  MORTISE_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  MORTISE_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  MORTISE_RPC_TLS_CERT=/path/to/cert.pem \\"
echo "  MORTISE_RPC_TLS_KEY=/path/to/key.pem \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""
