 ...
 * (~/.mortise/agent/auth.json, plaintext JSON with 0600 permissions).
 *
 * Usage:
...
export { PiCredentialStore, SecureStorageBackend, clearAllMortiseCredentials } from './backends/secure-storage.ts';
