...
declare const MORTISE_AGENT_CLI_VERSION: string | undefined;

export function getCurrentVersion(): string {
  if (typeof MORTISE_AGENT_CLI_VERSION !== 'undefined' && MORTISE_AGENT_CLI_VERSION != null) {
    return MORTISE_AGENT_CLI_VERSION;
  }
  return "0.0.1";
}
