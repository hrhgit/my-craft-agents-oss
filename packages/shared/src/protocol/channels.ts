...
export const RPC_CHANNELS = {
  ...
  sessions: {
    ...
    EVENT: 'session:event',
    PI_PROJECTION_EVENT: 'session:piProjectionEvent',
    GET_MODEL: 'session:getModel',
    SET_MODEL: 'session:setModel',
    GET_FILES: 'sessions:getFiles',
    READ_FILE: 'sessions:readFile',
    WRITE_FILE: 'sessions:writeFile',
  ...
  workspaces: {
    ...
    TRANSFER_JOURNAL_GET: 'workspaces:transferJournalGet',
    TRANSFER_JOURNAL_PREPARE: 'workspaces:transferJournalPrepare',
    TRANSFER_JOURNAL_PUBLISHED: 'workspaces:transferJournalPublished',
    TRANSFER_JOURNAL_SOURCE_RESOLVED: 'workspaces:transferJournalSourceResolved',
    TRANSFER_JOURNAL_ABORT: 'workspaces:transferJournalAbort',
    TRANSFER_JOURNAL_CLEANUP_COMPLETE: 'workspaces:transferJournalCleanupComplete',
    TRANSFER_JOURNAL_LIST_PENDING_CLEANUP: 'workspaces:transferJournalListPendingCleanup',
    TRANSFER_ENDPOINT_ACCESS: 'workspaces:transferEndpointAccess',
    TRANSFER_ENDPOINT_EXPORT_OPEN: 'workspaces:transferEndpointExportOpen',
    TRANSFER_ENDPOINT_EXPORT_READ: 'workspaces:transferEndpointExportRead',
    TRANSFER_ENDPOINT_EXPORT_COMPLETE: 'workspaces:transferEndpointExportComplete',
    TRANSFER_ENDPOINT_EXPORT_CLEANUP: 'workspaces:transferEndpointExportCleanup',
    TRANSFER_ENDPOINT_IMPORT_OPEN: 'workspaces:transferEndpointImportOpen',
    TRANSFER_ENDPOINT_IMPORT_WRITE: 'workspaces:transferEndpointImportWrite',
    TRANSFER_ENDPOINT_IMPORT_COMMIT: 'workspaces:transferEndpointImportCommit',
    TRANSFER_ENDPOINT_IMPORT_CLEANUP: 'workspaces:transferEndpointImportCleanup',
    TRANSFER_ENDPOINT_ABORT: 'workspaces:transferEndpointAbort',
    TRANSFER_RECEIPT_GET: 'workspaces:transferReceiptGet',
    TRANSFER_RECEIPT_RECORD: 'workspaces:transferReceiptRecord',
  },
  window: {
  ...
  layout: {
    GET: 'layout:get',
    SAVE: 'layout:save',
    DETACH_TAB: 'layout:detachTab',
    DETACH_GROUP: 'layout:detachGroup',
    REDOCK_WINDOW: 'layout:redockWindow',
  ...
  fs: {
    ...
    LIST_WORKSPACE_DIRECTORY: 'fs:listWorkspaceDirectory',
    SEARCH_WORKSPACE: 'fs:searchWorkspace',
    READ_WORKSPACE_PREVIEW: 'fs:readWorkspacePreview',
    READ_WORKSPACE_DRAFT: 'fs:readWorkspaceDraft',
    SET_WORKSPACE_DRAFT: 'fs:setWorkspaceDraft',
    DELETE_WORKSPACE_DRAFT: 'fs:deleteWorkspaceDraft',
    WRITE_WORKSPACE_TEXT: 'fs:writeWorkspaceText',
    CREATE_WORKSPACE_ENTRY: 'fs:createWorkspaceEntry',
    RENAME_WORKSPACE_ENTRY: 'fs:renameWorkspaceEntry',
    DELETE_WORKSPACE_ENTRY: 'fs:deleteWorkspaceEntry',
    WATCH_WORKSPACE: 'fs:watchWorkspace',
    UNWATCH_WORKSPACE: 'fs:unwatchWorkspace',
    WORKSPACE_CHANGED: 'fs:workspaceChanged',
  },
  debug: {
    LOG: 'debug:log',
  },
  ...
  tools: {
    ...
    GET_MESSAGING_TOOL_ENABLED: 'tools:getMessagingToolEnabled',
    SET_MESSAGING_TOOL_ENABLED: 'tools:setMessagingToolEnabled',
    GET_WEB_SEARCH_MODE: 'tools:getWebSearchMode',
    SET_WEB_SEARCH_MODE: 'tools:setWebSearchMode',
  },
  piExtensions: {
    ...
    GET_RUNTIME_STATE: 'piExtensions:getRuntimeState',
  ...
  extensions: {
    ...
    GET_FRONTEND_STATES: 'extensions:getFrontendStates',
  ...
  browserPane: {
    ...
    UPDATE_EMBED_BOUNDS: 'browser-pane:update-embed-bounds',
