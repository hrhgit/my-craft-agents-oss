...
Shared TypeScript types and utilities for Mortise Agent applications.

## Installation

```bash
# In a workspace package
bun add @mortise/core
```
...
// Import utilities
import { generateMessageId, debug } from '@mortise/core';
```
...
- `AgentEvent` - Events from MortiseAgent
