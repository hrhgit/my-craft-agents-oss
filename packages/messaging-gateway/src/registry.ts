...
import type { CredentialManager } from '@mortise/shared/credentials'
...
export interface MessagingGatewayRegistryOptions {
  ...
  whatsapp?: {
    /** Absolute path to the worker entry (packaged/unpacked from @mortise/messaging-whatsapp-worker). */
    workerEntry: string
