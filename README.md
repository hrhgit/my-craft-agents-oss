...
Mortise is an independently maintained, user-extensible desktop Agent platform. It combines a multi-session Electron client, a headless/WebUI server, the Pi agent runtime, skills, automations, and extension-contributed UI.
...
4. **Start chatting**: Create sessions and interact with Claude
...
mortise-cli run --workspace-dir ./my-project "Summarize this repository"
