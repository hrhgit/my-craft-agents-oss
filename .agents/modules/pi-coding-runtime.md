...
## Semantic history
- 2026-07-27: Replaced target-specific Extension declarations with one host-neutral manifest and catalog, added manifest-contributed subagent templates, and made persistent child runtime history resumable without synthetic user messages.
